                    ...
                    if (parameterInfo.validationNodeList != null) {
                        ...
                        for (int valIdx = 0; valIdx < valListSize; valIdx++) {
                            ...
                            try {
                                ...
                                eci.getMessage().addValidationError(null, parameterName, serviceName, "Value entered failed ${valNode.name} validation: ${t.message} " + map, null);
                            }
                        }
                    }
                }
        ...
        if ("val-or".equals(validateName)) {
            ...
            if (!(pv instanceof CharSequence)) {
                ...
                eci.getMessage().addValidationError(null, parameterName, serviceName,
                        "Value entered (${pv}) is not a string, cannot do matches validation. " + map, null);
                return false;
            }
            ...
            if (regexp != null && !regexp.isEmpty() && !pvString.matches(regexp)) {
                ...
                eci.getMessage().addValidationError(null, parameterName, serviceName, message != null && !message.isEmpty() ? message : "Value entered (${pv}) did not match expression: ${regexp} " + map, null);
                return false;
            }
            ...
            if (minStr != null && !minStr.isEmpty()) {
                ...
                if ("false".equals(valNode.attribute("min-include-equals"))) {
                    ...
                    if (bdVal.compareTo(min) < 0) {
                        ...
                        eci.getMessage().addValidationError(null, parameterName, serviceName, message + map, null);
                        return false;
                    }
                }
            }
            ...
            try {
                ...
                Map<String, Object> map = new HashMap<>(1); map.put("pv", pv);
                eci.getMessage().addValidationError(null, parameterName, serviceName, "Value [${pv}] is not a whole (integer) number." + map, null);
                return false;
            }
            ...
            try {
                ...
                map.put("pv", pv);
                eci.getMessage().addValidationError(null, parameterName, serviceName, "Value [${pv}] is not a decimal number. " + map, null);
                return false;
            }
            ...
            if (minStr != null && !minStr.isEmpty()) {
                ...
                if (str.length() < min) {
                    ...
                    eci.getMessage().addValidationError(null, parameterName, serviceName, "Value entered (${pv}), length ${str.length()}, is shorter than ${minStr} characters. " + map, null);
                    return false;
                }
            ...
            if (maxStr != null && !maxStr.isEmpty()) {
                ...
                if (str.length() > max) {
                    ...
                    eci.getMessage().addValidationError(null, parameterName, serviceName, "Value entered (${pv}), length ${str.length()}, is longer than ${maxStr} characters. " + map, null);
                    return false;
                }
            }
            ...
            if (!emailValidator.isValid(str)) {
                ...
                eci.getMessage().addValidationError(null, parameterName, serviceName, "Value entered (${str}) is not a valid email address. " + map, null);
                return false;
            }
            ...
            if (!urlValidator.isValid(str)) {
                Map<String, Object> map = new HashMap<>(1); map.put("str", str);
                eci.getMessage().addValidationError(null, parameterName, serviceName, "Value entered (${str}) is not a valid URL. " + map, null);
                return false;
            }
            ...
            for (char c : str.toCharArray()) {
                if (!Character.isLetter(c)) {
                    Map<String, Object> map = new HashMap<>(1); map.put("str", str);
                    eci.getMessage().addValidationError(null, parameterName, serviceName, "Value entered (${str}) must have only letters. " + map, null);
                    return false;
                }
            }
            ...
            for (char c : str.toCharArray()) {
                if (!Character.isDigit(c)) {
                    Map<String, Object> map = new HashMap<>(1); map.put("str", str);
                    eci.getMessage().addValidationError(null, parameterName, serviceName, "Value [${str}] must have only digits. " + map, null);
                    return false;
                }
            }
            ...
            if (after != null && !after.isEmpty()) {
                ...
                if (cal != null && cal.compareTo(compareCal) < 0) {
                    ...
                    eci.getMessage().addValidationError(null, parameterName, serviceName, "Value entered (${pv}) is before ${after}. " + map, null);
                    return false;
                }
            }
            ...
            if (before != null && !before.isEmpty()) {
                ...
                if (cal != null && cal.compareTo(compareCal) > 0) {
                    Map<String, Object> map = new HashMap<>(1); map.put("pv", pv);
                    eci.getMessage().addValidationError(null, parameterName, serviceName, "Value entered (${pv}) is after ${before}." + map, null);
                    return false;
                }
            }
            ...
            if (!ccv.isValid(str)) {
                Map<String, Object> map = new HashMap<>(1); map.put("str", str);
                eci.getMessage().addValidationError(null, parameterName, serviceName, "Value entered is not a valid credit card number." + map, null);
                return false;
            }
