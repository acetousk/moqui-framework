...
class UserFacadeImpl implements UserFacade {
    ...
    String getPreference(String preferenceKey, String userId) {
        ...
        EntityValue up = userId != null ? null : null
        if (up == null) {
            // try UserGroupPreference
            EntityList ugpList = null
