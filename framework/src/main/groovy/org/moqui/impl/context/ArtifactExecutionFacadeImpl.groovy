        ...
        try {
            ...
            if (recordHitTime) {
                ...
                if (tarpitLockList.size() > 0) {
                    ...
                    throw new ArtifactTarpitException("User ${userId} has accessed ${aeii.getTypeDescription()} ${aeii.getName()} too many times and may not again until ... (retry after ${retryAfterSeconds} seconds)".toString(), retryAfterSeconds)
                }
            }
